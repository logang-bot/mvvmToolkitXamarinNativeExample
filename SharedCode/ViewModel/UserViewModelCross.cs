...
{
	public class UserViewModelCross : MvxViewModel
	{
        ...
        public Post SinglePost
        {
            ...
            {
                singlePost = value;
                RaisePropertyChanged(() => SinglePost);
            }
        }

        public UserViewModelCross(IUserRepository userRepo)
        {
            this.repository = userRepo;

        }

        private IMvxCommand _loadSinglePostCommand;
        public IMvxCommand LoadSinglePostCommand
        {
            get
            {
                _loadSinglePostCommand = _loadSinglePostCommand ?? new MvxCommand(LoadSinglePost);
                return _loadSinglePostCommand;
            }
        }
        ...
        private async void LoadSinglePost()
        {
            ...
            try
            {
                ...
                SinglePost = await repository.GetSinglePost();
            }
            finally
            {
                //IsLoading = false;
